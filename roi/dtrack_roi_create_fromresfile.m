function outfilename=dtrack_roi_create_fromresfile(defloadpath, defsavepath, axhandle)
...
switch happy
    case 1
        ...
        if filename==0
            ...
            success=dtrack_fileio_saveroi(filename, [0 x(:)'], [0 y(:)']); %0 indicates polygon vertices
        end
        if success
